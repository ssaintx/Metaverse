  ...
  <section className={`${styles.paddings} relative z-10`} id="feedback">
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] lg:max-w-[370px] justify-end flex-col flex gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative"
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          ...
          today's work, or can be called web 3.0.
